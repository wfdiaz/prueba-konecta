...
<div class="flex flex-col p-2">
    <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
        ...
        <div class="my-2 shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
            ...
            <h1 class="p-2 text-2xl text-center text-blue3 font-bold border-blue3 my-2">Productos</h1>    
        ...
        <div class="w-full px-4 py-5 bg-white sm:w-full p-6 lg:w-full">
            ...
            <div class="grid grid-cols-12 gap-12">
                ...
                <div class="col-span-2 sm:col-span-2">
                    ...
                    <a href="{{route('product.detail', ['id' => 'nuevo']) }}" class="block p-2 w-40 bg-blue-900 text-white rounded-lg text-center">Nuevo</a>                   
                ...
                @foreach ($products as $producto)
                    <tr class="flex flex-col mb-1 md:table-row">
                        <td class="flex flex-no-wrap whitespace-nowrap text-sm text-gray-700 text-center md:table-cell">
                            ...
                            <span class="flex-grow p-1">{{ $producto->nombre_producto }}</span>
                    
                        </td>
                        <td class="flex flex-no-wrap whitespace-nowrap text-sm text-gray-700 text-center md:table-cell">
                          
                            <span class="w-20 flex-initial p-1 text-left text-gray-900 md:hidden">Referencia</span>
                            <span class="flex-grow p-1">{{ $producto->referencia }}</span>
                        ...
                        <td class="flex flex-no-wrap whitespace-nowrap text-sm text-gray-700 text-center md:table-cell">
                            ...
                            <span class="flex-grow p-1">{{ $producto->precio }}</span>

                        </td>
                        <td class="flex flex-no-wrap whitespace-nowrap text-sm text-gray-700 text-center md:table-cell">

                            <span class="w-20 flex-initial p-1 text-left text-gray-900 md:hidden">Peso</span>
                            <span class="flex-grow p-1">{{ $producto->peso }}</span>
                        ...
                        <td class="flex flex-no-wrap whitespace-nowrap text-sm text-gray-700 text-center md:table-cell">
                            ...
                            <span class="flex-grow p-1">{{ $producto->categoria }}</span>

                        </td> 
                        <td class="flex flex-no-wrap whitespace-nowrap text-sm text-gray-700 text-center md:table-cell">

                            <span class="w-20 flex-initial p-1 text-left text-gray-900 md:hidden">Stock</span>
                            <span class="flex-grow p-1">{{ $producto->stock }}</span>
                        ...
                        <td class="flex flex-no-wrap whitespace-nowrap text-sm text-gray-700 text-left md:table-cell">                                                                   
                                ...
                                <span class="w-20 flex-initial p-1 text-left text-gray-900 md:hidden">Editar</span>                
                                    <span class="flex-grow p-1 px-24 sm:flex-grow">
                                        
                                        <a href="{{ route('product.detail', $producto->id) }}" class="font-bold bg-blue3 rounded cursor-pointer text-center" >
                                            <i class="far fa-edit w-full h-6"> Editar</i>
                                        </a>
                                    </span>     
                        ...
                        <td class="flex flex-no-wrap whitespace-nowrap text-sm text-gray-700 text-left md:table-cell">                                                                   
                                ...
                                <span class="w-20 flex-initial p-1 text-left text-gray-900 md:hidden">Eliminar</span>                
                                    <span class="flex-grow p-1 px-24 sm:flex-grow">
                                        ...
                                        <a wire:click="$emit('deleteproduct', {{$producto->id}})" class="font-bold bg-blue3 rounded cursor-pointer text-center">
